package com.szrcb.ibs.sofawebdemo.web.test.base;

import com.szrcb.ibs.sofawebdemo.SofaWebDemoMain;
...
@SpringBootTest(classes = SofaWebDemoMain.class, webEnvironment = SpringBootTest.WebEnvironment.DEFINED_PORT)
